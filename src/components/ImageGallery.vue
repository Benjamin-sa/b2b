<template>
  <div class="space-y-2 sm:space-y-3 lg:space-y-4">
    ...
    <div class="relative aspect-square bg-gray-100 rounded-lg sm:rounded-xl overflow-hidden shadow-md sm:shadow-lg">
      ...
      <!-- Zoom Icon -->
      <button v-if="currentImage && allowZoom"
    ...
    <!-- Thumbnail Grid -->
    <div v-if="images.length > 1 && showThumbnails"
    ...
    <!-- Lightbox Modal -->
    <Teleport to="body">
      <div v-if="showLightbox" class="fixed inset-0 z-50 bg-black bg-opacity-90 flex items-center justify-center p-4"
        @click="closeLightbox">
