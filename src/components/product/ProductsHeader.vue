        ...
        <div class="bg-gray-50 border-b border-gray-200">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-2">
                <nav class="flex items-center space-x-2 text-sm">
                    ...
                    <span class="text-gray-900 font-medium">4Tparts</span>
                    <span v-if="activeCategory" class="text-gray-400">·</span>
                    <span v-if="activeCategory" class="text-gray-700">{{ activeCategory }}</span>
                </nav>
            </div>
        </div>
