<template>
    <Teleport to="body">
        ...
        <div class="notification-container-apple fixed top-0 left-1/2 transform -translate-x-1/2 z-[9999] flex flex-col items-center pointer-events-none w-full max-w-sm px-4"
            ...
            <TransitionGroup name="notification-apple" tag="div" class="space-y-3 w-full">
                <div v-for="notification in notificationStore.notifications" :key="notification.id"
                    class="notification-card-apple pointer-events-auto w-full"
