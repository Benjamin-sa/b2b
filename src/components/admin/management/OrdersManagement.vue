                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ stats?.overall?.total_invoices || 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ stats?.overall?.pending_count || 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">{{ stats?.overall?.confirmed_count || 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-5 w-0 flex-1">
                            <dl>
                                ...
                                <dd class="text-lg font-medium text-gray-900">€{{ stats?.overall?.total_revenue || 0 }}</dd>
                            </dl>
                        </div>
                    </div>
                </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    >
                        <svg v-if="sorting.order === 'desc'" class="h-5 w-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center space-x-2">
                        <span class="text-sm text-gray-600">
                            Page {{ pagination.page }} of {{ pagination.totalPages }} ({{ invoices.length }} of {{ pagination.total }} items)
                        </span>
                                ...
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        <tr v-for="item in selectedInvoice.items" :key="item.id">
                                            ...
                                            <td class="px-4 py-2 text-sm text-gray-900 text-right">€{{ item.unit_price }}</td>
                                            <td class="px-4 py-2 text-sm font-medium text-gray-900 text-right">€{{ item.total_price }}</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
