      ...
      <div>
        ...
        <input
          ...
          :class="[
            ...
            !vatValidation.isValid && form.btwNumber
        ...
        <div
          v-if="!vatValidation.isValid && form.btwNumber"
        ...
        <div
          v-else-if="vatValidation.isValid && vatValidation.countryName"
