<template>
  <form class="space-y-6" @submit.prevent="onSubmit">
    <div class="space-y-4">
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <input id="register-firstname" v-model="form.first_name" type="text" required :disabled="loading"
        ...
        <div>
          ...
          <input id="register-lastname" v-model="form.last_name" type="text" required :disabled="loading"
      ...
      <div>
        ...
        <input id="register-company" v-model="form.company_name" type="text" required :disabled="loading"
      ...
      <div>
        ...
        <input id="register-btw" v-model="form.btw_number" type="text" required :disabled="loading"
          :placeholder="$t('auth.vatPlaceholder')" :class="[
            ...
            !vatValidation.isValid && form.btw_number
              ? 'border-red-300 focus:ring-red-500 bg-red-50'
              : 'border-gray-300 focus:ring-blue-500',
          ]" @input="onVatInput" />
        <!-- BTW Validation Messages -->
        <div v-if="!vatValidation.isValid && form.btw_number"
          ...
          <div class="flex items-start">
            ...
            <div>
              <p class="text-sm text-red-600 font-medium">
                {{
                  vatValidation.error
                    ? $t(vatValidation.error, vatValidation.errorParams || {})
                    : ''
                }}
              </p>
        ...
        <div v-else-if="vatValidation.isValid && vatValidation.countryName"
          ...
          <div class="flex items-center">
            ...
            <p class="text-sm text-green-600 font-medium">
              {{ $t('auth.validVat', { country: vatValidation.countryName }) }}
            </p>
          </div>
        </div>
      ...
      <div>
        <label for="register-phone" class="block text-sm font-semibold text-gray-700 mb-2">
          {{ $t('auth.phone') }}
          <span class="text-gray-400 font-normal">{{ $t('auth.phoneOptional') }}</span>
        </label>
      ...
      <div class="bg-gray-50 rounded-xl p-6 space-y-4">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div class="sm:col-span-2">
            ...
            <input id="register-street" v-model="form.address.street" type="text" required :disabled="loading"
          ...
          <div>
            ...
            <input id="register-house" v-model="form.address.house_number" type="text" required :disabled="loading"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            ...
            <input id="register-postal" v-model="form.address.postal_code" type="text" required :disabled="loading"
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input id="register-confirm" v-model="form.confirmPassword" type="password" required :disabled="loading"
    ...
    <div v-if="!vatValidation.isValid && form.btw_number" class="p-3 bg-red-50 border border-red-200 rounded-lg">
      <div class="flex items-center">
