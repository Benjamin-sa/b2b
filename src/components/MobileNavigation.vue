    ...
    <div v-if="isOpen" class="md:hidden fixed inset-0 z-50 mobile-menu-overlay">
      ...
      <div class="relative bg-white h-full max-w-sm ml-auto shadow-2xl">
        ...
        <div
          ...
          <button class="p-2 text-gray-500 hover:text-primary-600 hover:bg-white rounded-lg transition-all"
            @click="$emit('close')">
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div class="py-4 border-t-2 border-primary-100">
            ...
            <nav class="space-y-1">
              ...
              <button v-if="isAdmin" class="mobile-nav-link group w-full text-left" @click="handleAdminToggle">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex-1 overflow-y-auto p-4">
          <div class="space-y-2">
            <button v-for="lang in languages" :key="lang.code" :class="[
              ...
              <svg v-if="currentLocale === lang.code" class="w-6 h-6 text-blue-600" fill="currentColor"
                viewBox="0 0 20 20">
