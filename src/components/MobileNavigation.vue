<template>
  ...
  <Transition name="mobile-menu">
    <div v-if="isOpen" class="md:hidden fixed inset-0 z-50 mobile-menu-overlay">
      ...
      <div class="relative bg-white h-full max-w-sm ml-auto shadow-2xl">
        <!-- Header -->
        <div
          class="flex items-center justify-between p-5 border-b-2 border-primary-200 bg-gradient-to-r from-primary-50 to-primary-100"
        >
          <div class="flex items-center space-x-3">
            <div
              class="w-12 h-12 bg-gradient-to-br from-primary-500 to-primary-700 rounded-full flex items-center justify-center shadow-lg"
            >
          ...
          <button
            class="p-2 text-gray-500 hover:text-primary-600 hover:bg-white rounded-lg transition-all"
            @click="$emit('close')"
          >
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div class="py-4">
            <div class="px-4 mb-3">
              <h3
                class="text-xs font-bold text-primary-700 uppercase tracking-wider flex items-center"
              >
            ...
            <nav class="space-y-1">
              <router-link to="/" class="mobile-nav-link group" @click="handleLinkClick">
              ...
              <router-link to="/products" class="mobile-nav-link group" @click="handleLinkClick">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <router-link to="/categories" class="mobile-nav-link group" @click="handleLinkClick">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
              ...
              <router-link to="/orders" class="mobile-nav-link group" @click="handleLinkClick">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <div class="py-4 border-t-2 border-primary-100">
            <div class="px-4 mb-3">
              <h3
                class="text-xs font-bold text-success-700 uppercase tracking-wider flex items-center"
              >
            ...
            <nav class="space-y-1">
              <router-link to="/profile" class="mobile-nav-link group" @click="handleLinkClick">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
          ...
          <div class="py-4 border-t-2 border-primary-100">
            <div class="px-4 mb-3">
              <h3
                class="text-xs font-bold text-secondary-700 uppercase tracking-wider flex items-center"
              >
            ...
            <div class="px-4">
              ...
              <button class="mobile-nav-link group w-full" @click="openLanguageModal">
                <svg class="mobile-nav-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path
                    stroke-linecap="round"
                    stroke-linejoin="round"
        ...
        <!-- Footer -->
        <div
          class="border-t-2 border-primary-200 p-5 bg-gradient-to-r from-danger-50 to-danger-100"
        >
          <button
  ...
  <Transition name="language-modal">
    ...
    >
      ...
      <!-- Modal Content -->
      <div
        class="relative w-full md:max-w-md bg-white rounded-t-2xl md:rounded-2xl shadow-2xl max-h-[80vh] flex flex-col"
      >
        <!-- Header -->
        <div
          class="flex items-center justify-between p-4 border-b bg-gray-50 rounded-t-2xl md:rounded-t-2xl"
        >
