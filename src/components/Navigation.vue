<template>
    <nav class="bg-white shadow-xl border-b-2 border-primary-200" ref="navRef">
                        ...
                        <Transition name="slide-fade">
                            <div v-if="showUserMenu"
                                ...
                                <div
                                    ...
                                    <div class="text-xs text-gray-600 mt-1 font-medium">{{ $t('navigation.accountSettings') }}</div>
                                </div>
