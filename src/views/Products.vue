<template>
    <div class="min-h-screen bg-secondary-50">
        <div class="bg-gradient-to-br from-slate-900 via-blue-900 to-blue-800 relative overflow-hidden">
            <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
                <div class="text-center">
                    ...
                    <div class="relative max-w-lg mx-auto">
                        ...
                        <div class="absolute right-2 top-2 p-2 text-slate-400">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="bg-white rounded-2xl shadow-lg border border-secondary-100 p-6 mb-8">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-end">
                    <div>
                        <label class="block text-sm font-semibold text-secondary-700 mb-2">Category</label>
                        <select v-model="filters.category"
                            class="w-full px-4 py-3 bg-secondary-50 border border-secondary-200 rounded-xl focus:ring-2 focus:ring-primary-500">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-secondary-700 mb-2">Availability</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-secondary-700 mb-2">Sort by</label>
                    ...
                    <div class="flex justify-end">
                        <button @click="clearFilters"
                            class="px-6 py-3 text-secondary-600 hover:text-secondary-800 hover:bg-secondary-100 rounded-xl font-medium">
                            Clear All
                        </button>
                    </div>
                </div>
            ...
            <div v-if="productStore.isLoading && !productStore.hasProducts" class="text-center py-24">
                <div
                    class="w-16 h-16 border-4 border-primary-200 border-t-primary-600 rounded-full animate-spin mx-auto">
                </div>
                <p class="mt-6 text-lg text-secondary-600 font-medium">Loading premium products...</p>
            </div>

            <div v-else-if="!productStore.hasProducts" class="text-center py-24">
                <h3 class="text-2xl font-bold text-secondary-900 mb-3">No products found</h3>
                <p class="text-secondary-600 mb-6">Try adjusting your search criteria or filters.</p>
                <button @click="clearFilters"
                    class="inline-flex items-center px-6 py-3 bg-primary-600 text-white font-medium rounded-xl hover:bg-primary-700">
                    Clear All Filters
                </button>
            </div>
            ...
            <div v-else>
                ...
                <div v-if="productStore.hasMoreProducts" class="mt-12 text-center">
                    <button @click="loadMore" :disabled="productStore.isLoading"
                        class="px-8 py-4 bg-primary-600 text-white font-bold rounded-full hover:bg-primary-700 disabled:bg-primary-300 transition-colors">
