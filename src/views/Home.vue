            ...
            <div class="card card-hover transition-smooth py-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p style="color: var(--color-text-secondary)">{{ $t('home.features.partsDesc') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-hover transition-smooth py-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p style="color: var(--color-text-secondary)">{{ $t('home.features.fastDeliveryDesc') }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="card card-hover transition-smooth py-4">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p style="color: var(--color-text-secondary)">{{ $t('home.features.b2bSupportDesc') }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card">
                ...
                <div class="space-y-3">
                    <router-link to="/products"
                        ...
                        <span class="text-gray-700 group-hover:text-primary-600 font-medium transition-smooth">{{
