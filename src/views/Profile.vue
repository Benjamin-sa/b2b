      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
          <div class="bg-white rounded-xl shadow-md overflow-hidden border border-gray-100">
            <div
              class="px-6 py-5 bg-gradient-to-r from-primary-50 to-primary-100 border-b border-primary-200"
            >
                ...
                <div>
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                      ...
                      <p class="text-gray-900 font-medium">
                        {{ authStore.userProfile?.companyName }}
                      </p>
                    </div>
                    <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                      <label class="block text-sm font-semibold text-gray-600 mb-2">{{
                      ...
                      <p class="text-gray-900 font-medium">
                        {{ authStore.userProfile?.btwNumber }}
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div class="p-4 bg-gray-50 rounded-lg border border-gray-100">
                    <div class="text-gray-900 font-medium space-y-1">
                      <p>
                        {{ authStore.userProfile?.address?.street }}
                        {{ authStore.userProfile?.address?.houseNumber }}
                      </p>
                      <p>
                        {{ authStore.userProfile?.address?.postalCode }}
                        {{ authStore.userProfile?.address?.city }}
                      </p>
            ...
            <div class="px-4 py-5 space-y-2">
              ...
              >
                <div class="p-2 bg-white rounded-lg shadow-sm">
                  <svg
                    class="w-5 h-5 text-success-600 group-hover:text-success-700"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
              ...
              >
                ...
                <div class="p-2 bg-white rounded-lg shadow-sm">
                  <svg
                    class="w-5 h-5 text-danger-600 group-hover:text-danger-700"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
