    ...
    <div class="min-h-screen bg-gray-50">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2">Complete your B2B order</p>
            </div>
                                ...
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-blue-800">
                                            We've pre-filled your shipping information from your profile.
                                        </p>
                                    </div>
                                </div>
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-6">
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="text-sm text-blue-700 mt-1">
                                        You will receive an invoice via email with 30 days payment terms.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <button @click="handleSubmit" :disabled="!isFormValid || orderStore.isLoading"
                            ...
                            <span v-if="orderStore.isLoading">Creating Invoice...</span>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <div class="mt-2">
                                    <p class="text-sm text-gray-500">
                                        Your order has been placed and an invoice will be sent to your email address.
                                        You can also view the invoice online.
                                    </p>
                                </div>
                            </div>
                        </div>
