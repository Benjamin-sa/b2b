  ...
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-primary-50/20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <div
        ...
        class="bg-white rounded-lg sm:rounded-xl shadow-lg p-6 sm:p-8 text-center"
      >
        <svg
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-3 space-y-4 sm:space-y-6">
          <!-- Shipping Address -->
          <div
            class="bg-white rounded-lg sm:rounded-xl shadow-xl p-4 sm:p-6 border-2 border-gray-100"
          >
            ...
            >
              ...
              >
                <svg
                  class="w-4 h-4 mr-1.5 text-success-600"
                  fill="currentColor"
                  viewBox="0 0 20 20"
                >
                  <path
            ...
            >
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                <div class="flex items-start sm:items-center">
                  <svg
                    class="flex-shrink-0 w-4 h-4 sm:w-5 sm:h-5 text-primary-500 mt-0.5 sm:mt-0"
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
              ...
              <div class="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    :class="[
                      'w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-base transition-all',
                      !form.shippingAddress.contactPerson?.trim()
                        ? 'border-danger-300 bg-danger-50/30'
                        : isAutoFilled && form.shippingAddress.contactPerson
                          ? 'border-success-300 bg-success-50/30'
                          : 'border-gray-300 bg-white',
                    ]"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      :class="[
                        'w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-base transition-all',
                        !form.shippingAddress.zipCode.trim()
                          ? 'border-danger-300 bg-danger-50/30'
                          : isAutoFilled && form.shippingAddress.zipCode
                            ? 'border-success-300 bg-success-50/30'
                            : 'border-gray-300 bg-white',
                      ]"
          ...
          >
                ...
                >
                  ...
                  >
                    ...
                    <div class="flex-1 min-w-0">
                      <p
                        class="text-sm sm:text-base font-bold text-gray-900 mb-1.5 sm:mb-2 leading-snug line-clamp-2"
                      >
                        {{ item.product.name }}
                      </p>
                      <div class="flex flex-col gap-2 sm:gap-2.5">
                        <div class="flex items-center gap-1.5 sm:gap-2.5">
                          ...
                          <div
                            class="flex items-center border-2 border-primary-200 rounded-lg bg-white shadow-sm"
                          >
                            <button
                      ...
                      <p
                        v-if="item.product.inventory?.shopify_variant_id"
            ...
            >
              ...
              <div class="flex justify-between text-base">
                <span class="text-gray-700 font-medium">{{
                  $t('checkout.summary.shipping', {
                    weight: cartStore.totalWeight.toFixed(2),
                  })
                }}</span>
                <span class="text-gray-900 font-semibold"
                  >€{{ formatPrice(cartStore.shippingCost) }}</span
                >
              </div>
              ...
              <div class="flex justify-between text-xl font-bold pt-1">
                ...
                <span
                  class="bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent"
                  >€{{ formatPrice(cartStore.grandTotal) }}</span
                >
              </div>
            </div>
            ...
            <div
              class="bg-gradient-to-r from-gray-50 to-primary-50/30 p-4 rounded-xl border-2 border-gray-200 mb-6"
            >
            ...
            <!-- Validation Message -->
            <div
              v-if="!isFormValid && !orderStore.isLoading"
