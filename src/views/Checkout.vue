                    ...
                    <div class="bg-white rounded-lg shadow-lg p-6 sticky top-6">
                            ...
                            <div v-for="item in cartStore.items" :key="item.productId"
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-xs text-gray-500">
                                        {{ $t('products.card.quantity') }}: {{ item.quantity }} × €{{ formatPrice(item.price) }}
                                    </p>
                                </div>
                        ...
                        <div class="space-y-2 mb-6">
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">{{ $t('checkout.summary.subtotal', { count: cartStore.itemCount }) }}</span>
                                <span class="text-gray-900">€{{ formatPrice(cartStore.subtotal) }}</span>
                            </div>
                            <div class="flex justify-between text-sm">
                                <span class="text-gray-600">{{ $t('checkout.summary.shipping', { weight: cartStore.totalWeight.toFixed(2) }) }}</span>
