<template>
  <div class="min-h-screen bg-gradient-to-br from-gray-50 to-primary-50/20">
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
      ...
      <!-- Empty Cart State -->
      <div v-if="cartStore.item_count === 0" class="bg-white rounded-lg sm:rounded-xl shadow-lg p-6 sm:p-8 text-center">
      ...
      <div v-else class="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 lg:gap-8">
        ...
        <div class="lg:col-span-3 space-y-4 sm:space-y-6">
          ...
          <div class="bg-white rounded-lg sm:rounded-xl shadow-xl p-4 sm:p-6 border-2 border-gray-100">
            ...
            <div
              class="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 pb-4 border-b-2 border-primary-200 gap-2">
              <div>
              ...
              <div v-if="isAutoFilled"
                class="flex items-center px-3 py-1.5 bg-gradient-to-r from-success-100 to-success-200 rounded-lg border border-success-300">
                <svg class="w-4 h-4 mr-1.5 text-success-600" fill="currentColor" viewBox="0 0 20 20">
                  <path fill-rule="evenodd"
                    d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z"
                    clip-rule="evenodd" />
                </svg>
                <span class="text-xs font-bold text-success-700">{{
            ...
            <div v-if="authStore.userProfile"
              class="mb-4 p-3 bg-gradient-to-r from-primary-50 to-primary-100 border border-primary-200 rounded-lg sm:rounded-xl">
              <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <button class="text-xs sm:text-sm text-primary-600 hover:text-primary-800 font-medium whitespace-nowrap"
                  @click="resetToProfileData">
                  >
              ...
              <div class="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <input v-model="form.shippingAddress.company" type="text" required :class="[
                    ...
                    !form.shippingAddress.company?.trim()
                      ? 'border-danger-300 bg-danger-50/30'
                      : isAutoFilled && form.shippingAddress.company
                ...
                <div>
                  ...
                  <input v-model="form.shippingAddress.contact_person" type="text" required :class="[
                    'w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-base transition-all',
                    !form.shippingAddress.contact_person?.trim()
                      ? 'border-danger-300 bg-danger-50/30'
                      : isAutoFilled && form.shippingAddress.contact_person
                        ? 'border-success-300 bg-success-50/30'
                        : 'border-gray-300 bg-white',
              ...
              <div class="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <input v-model="form.shippingAddress.street" type="text" required :class="[
                    ...
                    !form.shippingAddress.street.trim()
                      ? 'border-danger-300 bg-danger-50/30'
                      : isAutoFilled && form.shippingAddress.street
                        ? 'border-success-300 bg-success-50/30'
                        : 'border-gray-300 bg-white',
                ...
                <div class="grid grid-cols-1 sm:grid-cols-3 gap-3 sm:gap-4">
                  <div class="sm:col-span-2">
                    ...
                    <input v-model="form.shippingAddress.city" type="text" required :class="[
                      ...
                      !form.shippingAddress.city.trim()
                        ? 'border-danger-300 bg-danger-50/30'
                        : isAutoFilled && form.shippingAddress.city
                          ? 'border-success-300 bg-success-50/30'
                          : 'border-gray-300 bg-white',
                  ...
                  <div>
                    ...
                    <input v-model="form.shippingAddress.zip_code" type="text" required :class="[
                      'w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-base transition-all',
                      !form.shippingAddress.zip_code.trim()
                        ? 'border-danger-300 bg-danger-50/30'
                        : isAutoFilled && form.shippingAddress.zip_code
                          ? 'border-success-300 bg-success-50/30'
                          : 'border-gray-300 bg-white',
                ...
                <div>
                  ...
                  <select v-model="form.shippingAddress.country" required :class="[
                    ...
                    !form.shippingAddress.country
                      ? 'border-danger-300 bg-danger-50/30'
                      : isAutoFilled && form.shippingAddress.country
                        ? 'border-success-300 bg-success-50/30'
                        : 'border-gray-300 bg-white',
                  ]">
                ...
                <div>
                  ...
                  <input v-model="form.shippingAddress.phone" type="tel" :class="[
                    'w-full px-4 py-3 border-2 rounded-xl focus:ring-2 focus:ring-primary-500 focus:border-primary-500 text-base transition-all',
                    isAutoFilled && form.shippingAddress.phone
                      ? 'border-success-300 bg-success-50/30'
                      : 'border-gray-300 bg-white',
              ...
              <div class="space-y-3 sm:space-y-4">
                ...
                <div>
                  ...
                  <p class="mt-1 text-xs text-gray-500">
                    Add any special delivery instructions or requirements
                  </p>
                </div>
              </div>
            </form>
        ...
        <div class="lg:col-span-2">
          <div
            class="bg-white rounded-lg sm:rounded-xl shadow-xl p-5 sm:p-7 sticky top-4 sm:top-6 border-2 border-primary-100">
            <!-- Summary Header with Stats -->
            <div
              class="flex flex-col sm:flex-row items-start sm:items-center justify-between mb-5 pb-5 border-b-2 border-primary-200 gap-3">
              ...
              <div class="flex items-center gap-2 sm:gap-3">
                ...
                <button
                  ...
                  :title="showCartItems ? 'Hide items' : 'Show items'" @click="toggleCartItems">
                  <svg :class="[
                    'w-4 h-4 mr-1.5 transition-transform',
                    showCartItems ? 'rotate-180' : '',
            ...
            <Transition name="expand-cart">
              <div v-if="showCartItems" class="mb-5">
                <div
                  class="max-h-[400px] sm:max-h-[600px] overflow-y-auto space-y-2 sm:space-y-3 pr-1 sm:pr-2 cart-items-scroll">
                  <div v-for="item in cartStore.items" :key="item.product_id"
                    ...
                    <div
                      class="flex-shrink-0 w-16 h-16 sm:w-20 sm:h-20 bg-gray-200 rounded-lg sm:rounded-xl overflow-hidden border-2 border-gray-300">
                    ...
                    <div class="flex-1 min-w-0">
                      ...
                      <div class="flex flex-col gap-2 sm:gap-2.5">
                        <div class="flex items-center gap-1.5 sm:gap-2.5">
                          ...
                          <div class="flex items-center border-2 border-primary-200 rounded-lg bg-white shadow-sm">
                            <button :disabled="item.quantity <= (item.product.min_order_quantity || 1)"
                            ...
                            <input :value="item.quantity" type="number" :min="item.product.min_order_quantity || 1"
                            ...
                            <button :disabled="item.quantity >= (item.product.max_order_quantity || 999)"
                              class="px-2 sm:px-3 py-1 sm:py-1.5 text-primary-600 hover:bg-primary-50 disabled:opacity-30 transition-colors text-sm font-bold"
                          ...
                          <span class="text-xs sm:text-sm font-semibold text-gray-700">€{{ formatPrice(item.price)
                            }}</span>
                        </div>
                        <div class="flex items-center justify-between gap-2 sm:gap-3">
                          <span class="text-sm sm:text-base font-bold text-primary-700">€{{ formatPrice(item.price *
                            item.quantity) }}</span>
                          <button
                            class="p-1 sm:p-1.5 text-danger-500 hover:text-danger-700 hover:bg-danger-50 rounded-lg transition-colors"
                            :title="'Remove ' + item.product.name" @click="removeItem(item.product_id)">
                      ...
                      <p v-if="item.product.inventory?.shopify_variant_id"
                        class="text-xs text-gray-500 mt-1 sm:mt-2 font-mono bg-gray-100 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded inline-block">
            ...
            <!-- Price Breakdown -->
            <div
              class="space-y-3 mb-6 bg-gradient-to-br from-gray-50 to-primary-50/30 p-4 rounded-xl border-2 border-gray-200">
              <div class="flex justify-between text-base">
                <span class="text-gray-700 font-medium">{{
                  $t('checkout.summary.subtotal', {
                    count: cartStore.item_count,
                  })
                }}</span>
              ...
              <div class="flex justify-between text-base">
                <span class="text-gray-700 font-medium">{{
                  $t('checkout.summary.shipping', {
                    weight: cartStore.total_weight.toFixed(2),
                  })
                }}</span>
                <span class="text-gray-900 font-semibold">€{{ formatPrice(cartStore.shipping_cost) }}</span>
              </div>
              <div v-if="cartStore.should_show_vat" class="flex justify-between text-base">
              ...
              <div class="flex justify-between text-xl font-bold pt-1">
                ...
                <span class="bg-gradient-to-r from-primary-600 to-primary-700 bg-clip-text text-transparent">€{{
                  formatPrice(cartStore.grand_total) }}</span>
              </div>
            </div>
              ...
              <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                  ...
                  <span class="text-sm font-medium text-gray-700">{{
                    $t('checkout.invoiceLanguage.label')
                    }}</span>
                </div>
                <select v-model="invoiceLanguage"
            ...
            <!-- Submit Button -->
            <button :disabled="!isFormValid || orderStore.isLoading || cartStore.item_count === 0" :class="[
              'w-full py-3 px-4 rounded-md transition-colors duration-200 flex items-center justify-center font-medium',
              isFormValid && !orderStore.isLoading && cartStore.item_count > 0
                ? 'bg-blue-600 text-white hover:bg-blue-700'
                : 'bg-gray-300 text-gray-500 cursor-not-allowed',
            ]" @click="handleSubmit">
              <svg v-if="orderStore.isLoading" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" fill="none"
                viewBox="0 0 24 24">
            ...
            <!-- Validation Message -->
            <div v-if="!isFormValid && !orderStore.isLoading"
...
const normalizeCountryCode = (country: string | undefined): string => {
  ...
  if (
    upper.length === 2 &&
    ['BE', 'NL', 'DE', 'FR', 'GB', 'ES', 'IT', 'AT', 'CH', 'US'].includes(upper)
  ) {
    return upper;
  }
...
const fillFromProfile = () => {
  if (authStore.userProfile) {
    ...
    form.value.shippingAddress = {
      ...
      zip_code: profile?.address_postal_code || '',
      country: normalizeCountryCode(profile?.address_country ?? undefined),
      phone: profile.phone || '',
    };
