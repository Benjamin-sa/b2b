...
// ============================================================================
// PRODUCT INVENTORY - SIMPLIFIED (Shopify is source of truth)
// ============================================================================
...
export interface CreateProductRequest {
  ...
  // SIMPLIFIED: Only total_stock matters (Shopify is source of truth)
  total_stock?: number;
  // DEPRECATED: Kept for compatibility, ignored in new code
  b2b_stock?: number;
  b2c_stock?: number;
  stock_mode?: 'unified'; // Always unified now
  images?: string[];
