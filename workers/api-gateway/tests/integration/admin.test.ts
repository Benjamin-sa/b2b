...
describe('Integration: Admin Operations', () => {
  ...
  describe('GET /admin/users - List Users (Admin Only)', () => {
    ...
    it('should list users for admin', async () => {
      ...
      console.log(
        `[TEST] Listed ${response.data.users.length} users (total: ${response.data.total})`
      );
    });
    ...
    it('should support search', async () => {
      ...
      if (adminEmail) {
        ...
        const foundAdmin = response.data.users.some((user: any) => user.email === adminEmail);
  ...
  describe('PUT /admin/users/:userId - Update User (Admin Only)', () => {
    ...
    it('should update user details', async () => {
      ...
      const nonAdminUser = listResponse.data.users.find((user: any) => user.role !== 'admin');
  ...
  describe('POST /admin/users/:userId/verify - Verify User (Admin Only)', () => {
    ...
    it('should verify an unverified user', async () => {
      ...
      const unverifiedUser = listResponse.data.users.find((user: any) => user.isVerified === false);
