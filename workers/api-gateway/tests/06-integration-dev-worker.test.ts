  ...
  describe('POST /api/products - Create Product (Authenticated)', () => {
    ...
    it('should successfully create a product with complete valid data', async () => {
      ...
      const newProduct = {
        ...
        // Description & Details
        description:
          'This is a test product created by the integration test suite to verify the product creation endpoint works correctly.',
        brand: 'Test Brand',
      ...
      console.log(
        ...
        ADMIN_JWT_TOKEN ? `${ADMIN_JWT_TOKEN.substring(0, 20)}...` : 'NOT SET'
      );
